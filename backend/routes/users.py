...
def signup():
    ...
    try:
        ...
        # Employment - normalize employment type
        employment = data.get('employment_type') or data.get('employment')
        if employment:
            # Normalize: "Self-employed" -> "self employed", "Salaried" -> "salaried"
            employment = employment.lower().replace('-', ' ')
            user.employment_type = employment
